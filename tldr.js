...
(function() {
  var Narratives, Stories, Users, countStories, createStory, currentId, currentMode, doAnim, getStories, getStory, hideMedia, hideNarrative, hidePanel, isEditing, loadStory, populateNarrative, showMedia, showNarrative, showPanel;
    ...
    if (Meteor.isClient) {
      ...
      return Meteor.subscribe('stories', function() {
        loadStory(id, function(story) {
          return console.log('story loaded', story);
        });
        if (true === isEditing()) {
